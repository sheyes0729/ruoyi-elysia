...
export const OPER_LOG = {
  EXPORT: { title: "岗位管理-导出", businessType: "EXPORT" },
  DELETE: { title: "岗位管理-删除", businessType: "DELETE" },
  CREATE: { title: "岗位管理-新增", businessType: "INSERT" },
  UPDATE: { title: "岗位管理-编辑", businessType: "UPDATE" },
