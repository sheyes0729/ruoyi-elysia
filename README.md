...
- 进行中：系统管理模块 CRUD 深化（已完成用户/角色/菜单/部门/岗位/字典/参数/公告新增与编辑，已完成用户重置密码与角色菜单授权）与数据库落地
...
- [x] 完成用户/角色/菜单/部门/岗位/字典/参数/公告新增与编辑接口
- [ ] 完成用户重置密码、角色授权、菜单树授权等关键管理动作（已完成用户重置密码与角色菜单授权）
